...
---
## Logg på
Når du skal skrive dokumentasjon må du logge deg på [AktivKommune - Manual](https://manual.aktiv-kommune.no). Før du kan logge deg på må du opprettes som bruker. I hovedsak er det ansatte i offentlig sektor som skriver denne dokumentasjonen. Andre med spesiell interesse kan selvsagt også få tilgang. Vil du bli bruker sender kommunens **Systemadministrator** oss en melding til oss [her](https://manual.aktiv-kommune.no/?page_id=9).
