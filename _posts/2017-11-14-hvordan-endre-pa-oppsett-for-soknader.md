...
Dette gjøres under kommandoen: 
<strong>ADMINISTRASJON =&gt; BOOKING =&gt; KONFIGURASJON</strong>

I løsningen er det mulig å legge inn bilder/foto av de ulike utleieobjekter (ressurser). Dersom det legges inn høytoppløselige bilder,  kan dette gå utover hastigheten på visningen i frontend. For å unngå
